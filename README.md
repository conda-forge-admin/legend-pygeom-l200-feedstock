About legend-pygeom-l200-feedstock
==================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/legend-pygeom-l200-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/legend-pygeom-l200-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add legend-pygeom-l200
# for installing globally
pixi global install legend-pygeom-l200
```
...
It is possible to list all of the versions of `legend-pygeom-l200` available on your platform:
...
```
pixi search legend-pygeom-l200 --channel conda-forge
```
